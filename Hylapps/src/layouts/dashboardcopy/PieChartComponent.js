...
const PieChartComponent = ({ data }) => {
  ...
  const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042','#7C00FE','#FF6600','#219C90','#FDDE55','#06D001','#008DDA','#E72929','#9195F6','#FFEB00','#FF77B7','#10375C','#229799','#2C4E80','#597E52','#674188','#FFC7ED','#050C9C','#640D5F','#874CCC'];
